...
Это логическое продолжение проекта https://github.com/kaetosh/FlatTable1C_v2/blob/main/README.md, где добавлены новые виды обрабатываемых регистров, существенно оптимизирован (вайб-кодинг GPT и DeepSeek) общий алгоритм для ускорения обработки, добавлена **псевдографическая оболочка с возможностью использования мыши (необходим запуск в Windows Terminal)**.
